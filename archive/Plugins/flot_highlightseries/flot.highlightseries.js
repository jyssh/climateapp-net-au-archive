...
(function ($) {
	...
	function init(plot) {
	    ...
	    function highlightSeries(series, color) {
			...
			originalThicknesses[seriesAndIndex[0]] = series.lines.lineWidth;
		...
		function unHighlightSeries(series) {
			...
			seriesAndIndex[1].lines.lineWidth = originalThicknesses[seriesAndIndex[0]];
